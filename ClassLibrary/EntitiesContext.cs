...
namespace DAL
{
    ...
    public class EntitiesContext<T> where T : new()
    {
        private string connection;
        private SerializationType type;

        public EntitiesContext(SerializationType type, string connection)
        {
    ...
    public class CustomSerialization<T> where T : new()
    {
        ...
        static private string Serialize(object obj)
        {
            ...
            if (myType == typeof(Customer))
            {
                sb.AppendLine();
                sb.Append("{Customer}");
            }
            else if (myType == typeof(RealEstate))
            {
                sb.AppendLine();
